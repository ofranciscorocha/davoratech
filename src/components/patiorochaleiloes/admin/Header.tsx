...
export function Header() {
    // Mock logout function to match the signature in the original file
    const logout = () => { console.log("Logout triggered"); };

    return (
        <header className="flex items-center justify-between h-[50px] bg-[#3c8dbc] text-white shadow-sm w-full z-30">
            {/* Left side actions */}
            ...
            <div className="flex items-center h-full">
                ...
                <div className="flex items-center h-full">
                    <button
                        onClick={() => logout()}
                        className="flex items-center h-full px-4 hover:bg-[#c9302c] transition-colors cursor-pointer border-l border-[#367fa9]"
                    >
